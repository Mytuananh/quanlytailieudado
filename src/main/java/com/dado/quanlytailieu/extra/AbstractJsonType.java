...
public class AbstractJsonType<T> implements UserType<T> {
    ...
    AbstractJsonType(Class<T> type, Supplier<T> emptySupplier) {
        this.emptySupplier = emptySupplier;
        javaType = MAPPER.getTypeFactory().constructType(type);
    }

    AbstractJsonType(TypeReference<T> typeRef, Supplier<T> emptySupplier) {
        this.emptySupplier = emptySupplier;
